...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SettingType'
        db.create_table('settings_settingtype', (
        ...
        db.send_create_signal('settings', ['SettingType'])

        # Adding model 'Setting'
        db.create_table('settings_setting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('setting_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['settings.SettingType'])),
    ...
    def backwards(self, orm):
        # Deleting model 'SettingType'
        db.delete_table('settings_settingtype')
