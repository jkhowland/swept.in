...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SettingType.app'
        db.delete_column('settings_settingtype', 'app_id')


    def backwards(self, orm):
        # Adding field 'SettingType.app'
        db.add_column('settings_settingtype', 'app',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='setting_type', to=orm['apps.App']),
                      keep_default=False)
