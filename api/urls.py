...
from api.resources import AccountsResource, UserResource, SettingTypeResource, SettingResource, SubUserResource, SubUserDataResource, ActivityGroupResource, ActivityResource, EventResource, AppResource, AchievementTypeResource, AchievementResource
