...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityGroup.subuser'
        db.add_column('events_activitygroup', 'subuser',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['subusers.SubUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityGroup.subuser'
        db.delete_column('events_activitygroup', 'subuser_id')
    ...
    models = {
        ...
        'events.activity': {
            ...
            'activity_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.ActivityGroup']", 'null': 'True', 'blank': 'True'}),
            'app': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['apps.App']"}),
            'curriculum_bool': ('django.db.models.fields.IntegerField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
